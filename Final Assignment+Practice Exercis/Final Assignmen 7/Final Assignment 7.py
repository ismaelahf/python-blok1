...
def nieuwe_kluis():
    with open('kluizen.csv', 'r', newline='') as kluizen:
        ...
        if len(bezette_kluis_nummers) > 12:
            ...
            while True:
                ...
                if kluisNummer in bezette_kluis_nummers:
                    ...
                    with open('kluizen.csv', 'a', newline='') as kluizen2:
...
def kluis_openen():
    with open('kluizen', 'r', newline='') as kluizen:
        reader = csv.reader(kluizen, delimiter=';')
...
def kluis_teruggeven():
    with open('kluizen.csv', 'r', newline='') as kluizen:
        ...
        with open('kluizen.csv', 'w', newline='') as kluizen:
